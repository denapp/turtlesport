...
public class MapView extends javax.swing.JDialog implements ActionListener {
  ...
  public MapView(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  }
  ...
  public void initializeMapKit() {
    ...
    jXMapKit.setTileFactory(new DefaultTileFactory(new IGNMapTileProviderInfo("ign")));
//    jXMapKit
//        .setDefaultProvider(org.jdesktop.swingx.JXMapKit.DefaultProviders.OpenStreetMaps);
    ...
    jXMapKit.setCenterPosition(new GeoPosition(44.73820634186268, 5.554787227883935));
  ...
  public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        MapView dialog = new MapView(new javax.swing.JFrame(), true);
