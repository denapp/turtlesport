 ...
 * 
 */
public class MailClientWinThunderbird extends AbstractMailClientThunderbird {
  private String location;

  /**
   * 
   */
  protected MailClientWinThunderbird() {
    location = location();
    if (location == null) {
  ...
  private static String location() {
    String path = ":\\Program Files\\mozilla.org\\Mozilla\\thunderbird.exe";
