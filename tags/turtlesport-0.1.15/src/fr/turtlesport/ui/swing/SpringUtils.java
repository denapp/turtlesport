...
public final class SpringUtils {
   ...
   *          y padding between cells
   */
  public static void makeCompactGridSouth(Container parent,
                                     int rows,
                                     int cols,
                                     int initialX,
                                     int initialY,
   ...
   *          y padding between cells
   */
  public static void makeCompactGridNorth(Container parent,
                                     int rows,
                                     int cols,
                                     int initialX,
                                     int initialY,
